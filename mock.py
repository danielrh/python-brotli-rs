...
assert final_len == 20
assert output_buffer[0:final_len] == 'XXXXXXXXXXYYYYYYYYYY'
...
output_buffer = bytearray(15);
output_array = (ctypes.c_char * 15).from_buffer(output_buffer)
output_char_ptr = ctypes.cast(output_array, ctypes.c_char_p)
final_len = lib.brotli_decompress(input_char_ptr, input_length, output_char_ptr, 15)
print final_len
assert final_len == 20
assert output_buffer[0:15] == 'XXXXXXXXXXYYYYY'
